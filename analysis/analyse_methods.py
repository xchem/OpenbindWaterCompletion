...
def get_water_data(data_path, data, threshold=3.0):
    ...
    for (system, dtag, chain, res), paths in data.items():
        ...
        water_data[(system, dtag, chain, res)] = (
            ...
            get_ligand_waters(chain, res, st, threshold=threshold),
            )
...
if __name__ == "__main__":
    ...
    methods = {
        ...
        'findwaters_multiple_2_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=2)),
        'findwaters_multiple_3_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=3)),
        'findwaters_multiple_5_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=5)),
        'findwaters_multiple_7_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=7)),
        'findwaters_multiple_9_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=9)),
        'findwaters_multiple_11_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=11)),
        'findwaters_multiple_21_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=21)),
        # 'findwaters_multiple_31_steps': lambda st, xmap, chain, res, out_dir: findwaters_multiple(st, xmap, chain, res, out_dir, sigmas=np.geomspace(5.0,0.5,num=31)),
    ...
    data = {
        ...
        ('A71EV2A', 'A0310a', 'A', '147'): {
            'ground': 'A0310a_updated.pdb',
            'bound': 'A0310a_updated.pdb',
        ...
        ('CHIKV', 'c0289a', 'C', '401'): {
            'ground': 'c0289a_updated.pdb',
            'bound': 'c0289a_updated.pdb',
        ...
        ('SARS2_Nprot', 'Nprot-frag-x0098a', 'A', '401'): {
            'ground': 'Nprot-frag-x0098a_updated.pdb',
        ...
        ('SARS2_Nprot', 'Nprot-frag-x0190a', 'A', '465'): {
            ...
            'map': 'Nprot-frag-x0190a_event_crystallographic.ccp4'
        },
        ('SARS2_Nprot', 'Nprot-frag-x0220a', 'A', '501'): {
            'ground': 'Nprot-frag-x0220a_updated.pdb',
            'bound': 'Nprot-frag-x0220a_updated.pdb',
            'map': 'Nprot-frag-x0220a_event_crystallographic.ccp4'
        },
        ('SARS2_Nprot', 'Nprot-frag-x0263a', 'A', '401'): {
            'ground': 'Nprot-frag-x0263a_updated.pdb',
            'bound': 'Nprot-frag-x0263a_updated.pdb',
            'map': 'Nprot-frag-x0263a_event_crystallographic.ccp4'
        },
        ('DENV_NS5_RdRp', 'd0135a', 'A', '1608'): {
            'ground': 'd0135a_updated.pdb',
            'bound': 'd0135a_updated.pdb',
            'map': 'd0135a_event_crystallographic.ccp4'
        },
        ...
        ('DENV_NS5_RdRp', 'd0162a', 'A', '1707'): {
            'ground': 'd0162a_updated.pdb',
            'bound': 'd0162a_updated.pdb',
            'map': 'd0162a_event_crystallographic.ccp4'
        },
        ('DENV_NS5_RdRp', 'd0174a', 'A', '1608'): {
            'ground': 'd0174a_updated.pdb',
            'bound': 'd0174a_updated.pdb',
            'map': 'd0174a_event_crystallographic.ccp4'
        },
        ('DENV_NS5_RdRp', 'd0176a', 'A', '1701'): {
            'ground': 'd0176a_updated.pdb',
            'bound': 'd0176a_updated.pdb',
            'map': 'd0176a_event_crystallographic.ccp4'
        },
    }
